...
export default function PlayerStats({route, navigation}) {
     ...
     const {predictedPos} = route.params;
     //predictedPos
          ...
          <View style = {styles.container}>
               <View style = {styles.navigationContainer}>
                    ...
                    <View style = {styles.textOneContainer}>
                         <Text style = {styles.textOne}>Predicted Position</Text>
                    </View>
               </View>
               ...
               <View style = {styles.playerDetails}>
                    ...
                    <View style = {styles.stats}>
                         <Text style = {styles.statText1}>Current Position</Text><Text style = {styles.statText2}>{position}</Text>
                    </View>

                    <View style = {styles.stats}>
                         <Text style = {styles.statText1}>Predicted Position</Text><Text style = {styles.statText2}>{predictedPos}</Text>
                    </View>
                    {/* <View style = {styles.stats}>
